...
#load images
sun_img = pygame.image.load('map/img/sun.png')
sun_img = pygame.transform.scale(sun_img, (tile_size, tile_size))
bg_img = pygame.image.load('map/img/sky.png')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('map/img/tile.png')
grass_img = pygame.image.load('map/img/grass.png')
blob_img = pygame.image.load('map/img/blob.png')
platform_x_img = pygame.image.load('map/img/platform_x.png')
platform_y_img = pygame.image.load('map/img/platform_y.png')
lava_img = pygame.image.load('map/img/lava.png')
coin_img = pygame.image.load('map/img/coin.png')
exit_img = pygame.image.load('map/img/exit.png')
save_img = pygame.image.load('map/img/save_btn.png')
load_img = pygame.image.load('map/img/load_btn.png')
