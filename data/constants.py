...
PLATFORM_SPEED = (
    -240 * WIDTH_SCALE
)  # Negative because they move to the left -1 is good for tesing -5 is good tho i think
PLATFORM_WIDTH = 50 * WIDTH_SCALE  # 32
PLATFORM_AVRG_WIDTH = 100 * WIDTH_SCALE  # 32
PLATFORM_WIDTH_DEVIATION = (PLATFORM_AVRG_WIDTH * 0.10) * WIDTH_SCALE
PLATFORM_MIN_WIDTH = (PLATFORM_AVRG_WIDTH * 0.75) * WIDTH_SCALE
...
BRANCH_MIN_SPACING = 40 * HEIGHT_SCALE  # CAUTION: If to big, can cause loop
...
BACKGROUND_IMAGE_DIMENSIONS = [
    928 * WIDTH_SCALE,
    600 * HEIGHT_SCALE,
]  # Width and Height of background image file, used for moving background
...
SCREEN_POSITIONS = {
    key: {
        ...
        for inner_key, (x, y) in sub_dict.items()
    }
